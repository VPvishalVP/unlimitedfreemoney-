...
{
	$url1="https://microsecure.website/$hostt/api/savePaytmRequest//";

$data1="user_id=$user&name=paytm&point=$ad";
...
echo "<fieldset><div><font color='blue' size='3'>$msg</font></div></fieldset>";
